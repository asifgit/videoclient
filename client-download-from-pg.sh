...
# 4K Download
#wget "http://${PG_PUBLIC_IP}:8000/static/videos/videos/4kAfricanWildlifeAfricanNatureShowreel2017ByRobertHofmeyr.webm"
#wget "http://${PG_PUBLIC_IP}:8000/static/videos/videos/4kCostaRicaIn4K60fpsHDR.webm"
#wget "http://${PG_PUBLIC_IP}:8000/static/videos/videos/4kTravelToJejuSouthKorea.webm"
# 1K Download
#wget "http://${PG_PUBLIC_IP}:8000/static/videos/videos/BoeingF15SeSilentEagleStealthFighterForSouthKorea.mp4"
#wget "http://${PG_PUBLIC_IP}:8000/static/videos/videos/MajesticFlightsSouthKorea.mp4"
#wget "http://${PG_PUBLIC_IP}:8000/static/videos/videos/TereJaisaYaarKahanKoreanVersionOfSong.mp4"
# 720P Download
#wget "http://${PG_PUBLIC_IP}:8000/static/videos/videos/CanonPowershotVideo.mp4"
#wget "http://${PG_PUBLIC_IP}:8000/static/videos/videos/NatureBeautiful.mp4"
#wget "http://${PG_PUBLIC_IP}:8000/static/videos/videos/SamsungDemoVideo.mp4"
